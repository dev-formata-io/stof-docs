---
description: Image Library ("image" feature)
---

# Image Library (Image)

Functions for working with images, loaded into Stof via the custom Data type. This can be done with several image formats. Requires the "image" feature flag to be enabled.
...
## Image.fast\_blur(img: Data\<Image>, blur: float) -> void

Blur this image with the given blur value (sigma in a gaussian blur).

## Image.flip\_horizontal(img: Data\<Image>) -> void

Flip this image horizontally.

## Image.flip\_vertical(img: Data\<Image>) -> void

Flip this image vertically.

## Image.from\_blob(bytes: blob) -> Data\<Image>
...
## Image.resize\_exact(img: Data\<Image>, width: int, height: int) -> bool

Resize this image, without preserving it's aspect ratio. Will return true if the image was successfully resized.

## Image.rotate\_180(img: Data\<Image>) -> void

Rotate this image 180 degrees clockwise.

## Image.rotate\_270(img: Data\<Image>) -> void

Rotate this image 270 degrees clockwise.

## Image.rotate\_90(img: Data\<Image>) -> void
...
## Image.thumbnail\_exact(img: Data\<Image>, width: int, height: int) -> bool
