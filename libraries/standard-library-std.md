...
## Std.assert\_eq(first: unknown, second: unknown) -> void
...
## Std.assert\_neq(first: unknown, second: unknown) -> void
...
## Std.assert\_not(value: unknown = true) -> void
...
## Std.format\_content\_type(format: str) -> str
