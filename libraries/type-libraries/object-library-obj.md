---
description: Linked with the "obj" type.
---
...
## Obj.create\_type(obj: obj, typename: str) -> void
...
## Obj.instance\_of(obj: obj, proto: str | obj) -> bool
...
## Obj.is\_parent(obj: obj, other: obj) -> bool
...
## Obj.move\_field(obj: obj, source: str, dest: str) -> bool
...
## Obj.remove\_prototype(obj: obj) -> void
...
## Obj.schemafy(schema: obj, target: obj, remove\_invalid: bool = false, remove\_undefined: bool = false) -> bool
...
## Obj.set\_prototype(obj: obj, proto: obj | str) -> void
