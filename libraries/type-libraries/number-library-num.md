---
description: Linked to number types.
---
...
## Num.has\_units(val: int | float) -> bool
...
## Num.is\_angle(val: int | float) -> bool
...
## Num.is\_length(val: int | float) -> bool
...
## Num.is\_mass(val: int | float) -> bool
...
## Num.is\_time(val: int | float) -> bool
...
## Num.remove\_units(val: int | float) -> int | float
...
## Num.to\_string(val: int | float) -> str
