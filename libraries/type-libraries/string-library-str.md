---
description: Linked with the "str" type.
---
...
## Str.ends\_with(val: str, seq: str) -> bool
...
## Str.index\_of(val: str, seq: str) -> int
...
## Str.starts\_with(val: str, seq: str) -> bool
